...
export const TaskModal = (props:Props) => {
    ...
    return(
        props.isOpen ? (
            <div
               id={uuid}
               className="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full justify-center items-center flex bg-zinc-400"
               tabIndex={tabIndex}
